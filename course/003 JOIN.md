...
Приготовтесь, сейчас будет то, ради чего мы изучали JOIN'ы - для того, что отвечать на вопросы по ним на собеседованиях
...
Давайте разберем пример на INNER JOIN 
